...
export const navMenuItemsArray =
    [
        ...
        {route: 'dessert', titleEn: 'Dessert', titleRu: 'Десерты', titleHe: 'קינוח'}
     ];

export const headerEn = {text: 'Welcome to “Stalkers Social Club”!\n' +
        'Here, the sound of freedom, friendship, and great vibes fills the air. We’re a place for everyone who loves lively evenings, live music, and a cozy atmosphere.\n' +
        'At “Stalkers Social Club,” you’ll find:\n' +
        ' • Live concerts: From rock and blues to alternative, for anyone who appreciates quality sound.\n' +
        ' • A welcoming vibe: Warmth and a sense of belonging for every guest.\n' +
...
export const headerRu = {text: 'Добро пожаловать в “Stalkers Social Club”!\n' +
        ...
        ' • Живые концерты: от рока и блюза до альтернативы, для всех, кто любит качественный звук.\n' +
...
export const headerHe = {text: 'ברוכים הבאים ל "Stalkers Social Club"\n' +
        ...
        '   • קונצרטים חיים: מרוק ובלוז ועד מוזיקה אלטרנטיבית - לכל מי שמעריך סאונד איכותי.\n' +
...
export const eventRu = 'Бронирование мест 0545574713 - только WhatsApp!!!\n Укажите ваше имя, дату и название мероприятия, а так же количество мест.\n' +
    'Проверьте, что вам подтвердили бронь в чате WhatsApp!\n' +
    'Пожалуйста, уважайте артистов, организаторов и других желающих попасть на концерт, в случае, если вы не можете прийти на концерт, или у вас изменилось количество заказанных мест - сообщите нам в чате WhatsApp.\n' +
    'Увидимся у StalkerS!'
export const eventEn = 'Reservation of seats 0545574713 - WhatsApp only!\n' +
    'Please provide your name, event date, event name, and the number of seats you wish to book.\n' +
    'Make sure to check that your reservation has been confirmed in the WhatsApp chat.\n' +
    'Please respect the artists, organizers, and other attendees. If you are unable to attend the concert or need to change the number of reserved seats, kindly inform us in the WhatsApp chat.\n'+
    'See you at StalkerS!'
export const eventHE = 'הזמנת מקומות ב-0545574713 – רק בווצאפ\n' +
    'אנא ציינו את שמכם, תאריך האירוע ושם האירוע, וכן את מספר המקומות.\n' +
    'אנא ודאו שקיבלתם אישור להזמנה בצ\'אט של הווצאפ\n' +
